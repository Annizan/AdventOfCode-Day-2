...
namespace Day2_Corruption_Checksum
{
    class Program
    {
        ...
        {
            List<string> puzzle = new List<string> {"798	1976	1866	1862	559	1797	1129	747	85	1108	104	2000	248	131	87	95",
            ...
            CheckSumCalculator checkSumCalculator = new CheckSumCalculator(puzzle);
            Console.WriteLine(checkSumCalculator.Calculate());
            Console.ReadLine();
